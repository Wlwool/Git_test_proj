"""
Хозяева пиццерии хотят иметь возможность быстро рассчитывать стоимость отдельного
ингредиента и полную стоимость пиццы.
...
Начальная реализация классов Pizza и Ingredient уже имеется,
необходимо дописать вычисляемое свойство cost.
"""
